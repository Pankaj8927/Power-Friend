  ...
  <div class=" m-0 p-0 row d-flex flex-column justify-content-start justify-content-lg-center align-items-center"
    ...
    <div class="position-absolute overflow-auto col-12 main m-0 p-10  overflow-auto w-100"
      ...
      <div class="container mt-3 d-flex flex-column flex-wrap justify-content-center align-items-center">
        ...
        <div class="oderDetails m-0 p-0" style="width:90%;height:auto;">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="p-0 col-12 position-relative d-flex flex-column justify-content-center align-items-center">
              <div class="progressOrderStatus d-flex justify-content-center align-items-center position-relative" style="width:95%;">
                  <div class="statusButton d-flex flex-row justify-content-between align-items-center w-100">
                      <button class="d-flex justify-content-center align-items-center btn bg-dark text-white rounded-circle" style="height:40px;width:40px;" data-bs-toggle="tooltip"
                          title="Order Confirmed">
                          <i class="text-light fas fa-clipboard-list"></i>
                      </button>
                      <button class="d-flex justify-content-center align-items-center btn bg-dark text-white rounded-circle" style="height:40px;width:40px;" data-bs-toggle="tooltip"
                          title="Order Shipped">
                          <i class="text-light fas fa-box-open"></i>
                      </button>
                      <button class="d-flex justify-content-center align-items-center btn bg-dark text-white rounded-circle" style="height:40px;width:40px;" data-bs-toggle="tooltip"
                          title="Out for Delivery">
                          <i class="text-light fas fa-shipping-fast"></i>
                      </button>
                      <button class="d-flex justify-content-center align-items-center btn bg-dark text-white rounded-circle" style="height:40px;width:40px;" data-bs-toggle="tooltip"
                          title="Order Delivered">
                          <i class="text-light fas fa-home"></i>
                      </button>
                  </div>
                  <div class="z-n1 progress-container position-absolute">
                      <div id="progressBar" class="progress-bar" style="width: <?php echo $progressWidth; ?>;"></div>
                  </div>
              </div>
              <div class="d-flex justify-content-between align-items-center w-100">

                  <div class="d-flex flex-column w-auto">
                      <div class="d-flex flex-column mt-2 order-status">
                          <p class="fw-bold mb-1  <?php echo $highlighted['order_confirmed']; ?> text-center">Order<br>Confirmed</p>
                      </div>
                  </div>

                  <div class="d-flex flex-column w-auto">
                      <div class="d-flex flex-column mt-2 order-status">
                          <p class="fw-bold mb-1  <?php echo $highlighted['order_shipped']; ?> text-center">Order<br>Shipped</p>
                      </div>
                  </div>

                  <div class="d-flex flex-column w-auto">
                      <div class="d-flex flex-column mt-2 order-status">
                          <p class="fw-bold mb-1 <?php echo $highlighted['out_for_delivery']; ?> text-center">Out For<br>Delivery</p>
                      </div>
                  </div>

                  <div class="d-flex flex-column w-auto">
                      <div class="d-flex flex-column mt-2 order-status">
                          <p class="fw-bold mb-1  <?php echo $highlighted['order_delivered']; ?> text-center">Order<br>Delivered</p>
                      </div>
                  </div>
              </div>
